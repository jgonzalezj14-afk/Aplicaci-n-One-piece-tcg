                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                        ...
                        child: Container(
                            ...
                            child: ClipRRect(borderRadius: BorderRadius.circular(2), child: Image.network(card.imageUrl, fit: BoxFit.cover, errorBuilder: (c,e,s) => Container(color: Colors.grey)))
                        )
                    );
                  },
                ),
